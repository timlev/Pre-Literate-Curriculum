...
wordlist = ["bathroom","kitchen","bedroom","ceiling","dining room","closet","hall","floor","wall"]
wordlist = ["chair","couch","table","lamp","bed","dresser","mirror","TV","rug","clock"]
wordlist = ["low","on","stove","fan","high","off","heat","medium","microwave","AC"]
wordlist = ["toilet","window","broken","sink","tub","door","locked","fridge","shower","leaking"]
wordlist = ["social security number","address","check","rent","apartment","signature","money order","manager","phone number","name"]
